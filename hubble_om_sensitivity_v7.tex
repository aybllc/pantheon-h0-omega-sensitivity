...
Both diagnostics are mutually consistent.
Under this diagnostic, the $\Omega_m$ prior difference between the
two frameworks contributes ${\lesssim}\,4$\,\% of the nominal
SH0ES--Planck gap; the remaining discrepancy lies outside the
component measured here and requires matched-likelihood analyses
with the full covariance matrices of both experiments.
\end{abstract}
...
\begin{equation}
  ...
  \label{eq:fraction}
\end{equation}
This is the fraction of the nominal tension attributable
to the $\Omega_m$ model assumption difference under this diagnostic.
...
These results provide a clean empirical baseline for the
$\Omega_m$-driven component of the Hubble tension.
The remainder is not measured by this analysis and requires
matched-likelihood treatment with the full covariance structure
of both experiments.
